...
requests, discussions, and any other communication channel associated with
this repository), and also applies when an individual is officially
...
reported by [opening a private security advisory](https://github.com/dev-saurav61295/formknot/security/advisories/new)
or, for non-sensitive reports, by opening a GitHub issue on this repository.
GitHub's own [reporting a user](https://docs.github.com/en/communities/maintaining-your-safety-on-github/reporting-abuse-or-spam)
mechanism is also available for content that violates GitHub's own terms.
...
interaction with the people involved for a specified period of time. Further
violations may lead to a temporary or permanent ban.
